      ...
      >
        {whitepapers.map((item, idx) => (
          ...
          >
            ...
            <div
              className="flex flex-col items-center justify-center border-[0.06rem] hover:border-slate-700 border-[#444D61] md:px-10  px-2 md:py-3 py-1 md:rounded-2xl rounded-md bg-black md:w-[34rem] md:h-[18rem]  2xl:w-[40rem] 2xl:h-[16rem] w-[22rem] h-[24rem] relative z-20"
            >
              <div className="h-full flex sm:flex-row flex-col items-center md:gap-8 py-2  ">
                ...
                <div className='h-full flex flex-col items-center justify-center sm:py-4 py-1 gap-4 '>
                  ...
                  <div className='w-full flex  items-center justify-center sm:justify-start pl-2 '>
                    <div onClick={() => window.open(item.link, '_blank', 'noopener,noreferrer')} className={`w-1/3 xl:w-1/3 md:w-1/2 flex items-center justify-center cursor-pointer border-[#444D61] border-[0.06rem]  px-2 py-2 rounded-lg hover:bg-[#13151A] text-white font-RobotoMedium text-xs md:text-sm z-50  ${hoveredIndex ===idx ?  "bg-[#13151A]" : "bg-black" }`}>
                      Read more
