...
export default function Whitepapersverticalcontainer() {
  ...
  return (
    <div className="relative w-full">
      <div
        className="grid  justify-items-center items-center grid-cols-1 md:grid-cols-2  py-5"
      ...
      >
        {whitepapers.map((item, idx) => (
          ...
          >
            ...
            <div
              className="flex flex-col items-center justify-center border-[0.06rem] hover:border-slate-700 border-[#444D61] md:px-3 px-2 md:py-3 py-1 md:rounded-2xl rounded-md bg-black md:w-[25rem] md:h-[30rem]  xl:w-[30rem] xl:h-[15rem] 2xl:w-[40rem] 2xl:h-[20rem] w-[22rem] h-[24rem] relative z-20"
            >
