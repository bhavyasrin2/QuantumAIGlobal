      ...
      <div className="w-full h-full relative">
        <div className="absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[80%] md:w-[60rem] flex flex-col items-center gap-1 justify-center">
          <div className="w-full flex flex-col items-center justify-center">
            <div className="w-full  text-center md:h-[3.5rem] 2xl:h-[3.9rem] font-RobotoBold z-0 wordGradient md:text-5xl 2xl:text-6xl text-3xl">
              {props.title1}
            </div>
            <div className="w-full md:h-[3.5rem]  2xl:h-[3.9rem] text-center z-0 font-RobotoBold wordGradient md:text-5xl 2xl:text-6xl text-3xl  ">
              {props.title2}
            </div>
          </div>
