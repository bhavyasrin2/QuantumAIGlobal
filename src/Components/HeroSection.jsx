  ...
  return (
    <div className="h-full w-full  relative flex items-center justify-center">
      <div className="w-full h-full relative">
        <div className="absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[90%] md:w-[60rem] flex flex-col items-center gap-1 justify-center">
    ...
    <div className="h-full w-full  relative flex items-center justify-center ">
      <div className="w-full h-full relative">
        <div className="absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[80%] md:w-[60rem] flex flex-col items-center gap-1 justify-center">
          <div className="w-full flex flex-col items-center justify-center">
            <div className="w-full  text-center  font-RobotoBold z-0 text-white md:text-5xl 2xl:text-6xl text-3xl">
              {props.title1}
            </div>
            <div className="w-full  font-RobotoBold z-0 wordGradient md:text-5xl 2xl:text-6xl text-3xl text-center">
              {props.title2}
            </div>
          </div>
          <p className="w-full max-w-xl text-center text-white font-RobotoRegular text-xs md:text-sm mt-4">
