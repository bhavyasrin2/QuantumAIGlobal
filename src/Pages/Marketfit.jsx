            ...
            <TitleContent title="Our Solutions in Quantum Communication" content="" />
                ...
                <div className='w-full md:w-[77.5rem] flex flex-col-reverse sm:flex-row items-center justify-center gap-3'>
                    ...
                    <div className='w-[85%] flex flex-col items-center justify-center gap-4'>
                        <div className='w-full sm:w-[80%] font-RobotoRegular text-[#1B99D4] text-xl 2xl:text-2xl sm:text-left text-center'>Quantum-Safe Enterprise Security
                        ...
                        <div className='w-full flex flex-col items-center justify-center gap-1'>
                            ...
                            <div className='sm:w-[80%] w-[95%] font-RobotoRegular  text-xs md:text-sm text-[#ffffff]   text-justify'>Consider this: How swiftly can your cryptographic infrastructure be upgraded inresponse to such a development? What is the anticipated lifespan of your data under these circumstances? These questions demand immediate attention.</div>
                            <div className='sm:w-[80%] w-[95%] font-RobotoRegular  text-xs md:text-sm text-[#ffffff]  text-justify'>Failure to address these critical concerns could leave your organization vulnerable to security breaches and data compromise. By taking proactive measures now, you can position yourself ahead of the curve and mitigate potential risks.</div>
                            <div className='sm:w-[80%] w-[95%] font-RobotoRegular  text-xs md:text-sm text-[#ffffff]   text-justify'>We swear by remembering, readiness is not just about reacting swiftly; it&#39;s about planning strategically. By understanding the implications and timelines involved, you can allocate resources effectively and adapt to evolving standards. The time to act is now. Don&#39;t wait until it&#39;s too late.Our line up of product solutions are built to empower businesses to excel in a time of swift technological progress.</div>
                ...
                <div className='w-[85%] md:w-[77.5rem]  flex  items-center justify-center gap-3'>
                    <div className='w-full sm:w-[80%]  flex flex-col sm:flex-row-reverse items-center  justify-center gap-4 sm:gap-6'>
                        ...
                        <div className='w-full sm:w-[70%] flex flex-col items-center justify-center gap-4'>
                            <div className='w-full flex flex-col items-center justify-center gap-4'>
                                <div className='sm:w-full w-[100%] font-RobotoRegular text-[#1B99D4] text-xl 2xl:text-2xl sm:text-left text-center'>Quantum Key Distribution


                                </div>
                                <div className='w-full flex flex-col items-center justify-center gap-1'>
                                    <div className='sm:w-full w-[95%] font-RobotoRegular  text-xs md:text-sm text-[#ffffff] text-justify'>Quantum Key distribution is the logical next step towards Quantum safety. Once data is encrypted, the interception of the key that was used for the encryption would nullify the effect of the encryption.</div>
                                </div>
                            </div>
                ...
                <div className='w-full md:w-[77.5rem]  flex flex-col items-center justify-center my-10 '>
                    <div className='w-[85%] flex flex-col items-center justify-center '>
                        <div className='w-full sm:w-[80%] font-RobotoRegular text-[#1B99D4] text-xl 2xl:text-2xl sm:text-left text-center'>Product suite we offer
                        ...
                        <div className='w-full sm:w-[80%] flex flex-col sm:flex-row items-center justify-center '>
                            ...
                            <div className='w-full flex flex-col items-center justify-center gap-4 py-2'>
                                <div className='w-full flex flex-col sm:flex-row items-center justify-center gap-4'>
                                    ...
                                    <div className='w-full flex flex-col items-center justify-center gap-1'>
                                        <div className='w-full font-RobotoRegular text-[#1B99D4] text-[1rem]   text-center sm:text-left'>Quantum Migration
                                ...
                                <div className='w-full flex flex-col sm:flex-row items-center justify-center gap-4'>
                                    ...
                                    <div className='w-full flex flex-col items-center justify-center gap-1'>
                                        <div className='w-full font-RobotoRegular  text-[#1B99D4] text-[1rem] text-center sm:text-left'>Quantum Ready
                ...
                <div className='w-[85%] md:w-[77.5rem] flex  items-center justify-center gap-3'>
                    <div className='w-full sm:w-[80%]  flex flex-col sm:flex-row-reverse items-center  justify-center gap-4 sm:gap-6'>
                        ...
                        <div className='w-full sm:w-[70%] flex flex-col items-center justify-center gap-4'>
                            ...
                            <div className='w-full flex flex-col items-center justify-center gap-1'>
                                <div className='sm:w-full w-[100%] font-RobotoRegular  text-[#3b84b4] text-[1rem] sm:text-left text-center'>Q-Folio Pro </div>
                                <div className='w-full flex flex-col items-center justify-center gap-1'>
                                    <div className='sm:w-full w-[95%] font-RobotoRegular  text-xs md:text-sm text-[#ffffff] text-justify'>When it comes to using advanced technology to increase profit, reduce cost, and improve efficiency, financial institutions have often led the way. Today, many of those same companies are at the forefront of exploring how quantum computers can be used to drive competitive advantage. Optimization is at the Heart of Finance. With Q-Folio pro a quantum-hybrid approach we are ready to tackle this problem successfully.</div>
                                </div>
                                {/* <div>
